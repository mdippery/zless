...
from zscope.paths import output_path, to_path
...
@pytest.mark.parametrize(
    ...
    [
        ("zscope-22.1.dev0/PKG-INFO", "/tmp/PKG-INFO", Path("/tmp/PKG-INFO")),
        ("zscope-22.1.dev0/PKG-INFO", "/tmp/blah", Path("/tmp/blah")),
        ("zscope-22.1.dev0/PKG-INFO", "/tmp/", Path("/tmp/PKG-INFO")),
        ("zscope-22.1.dev0/PKG-INFO", "/tmp", Path("/tmp/PKG-INFO")),
    ],
)
